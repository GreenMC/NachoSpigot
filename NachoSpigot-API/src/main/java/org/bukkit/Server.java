...
public interface Server extends PluginMessageRecipient {
    ...
    void setMaxPlayers(int maxPlayers); // [Nacho-0021] Add setMaxPlayers within Bukkit.getServer() and SetMaxSlot Command
     ...
     */
     ...
     void setKnockbackFriction(double d);
     void setKnockbackHorizontal(double d);
     void setKnockbackVertical(double d);
     void setKnockbackVerticalLimit(double d);
     void setKnockbackExtraHorizontal(double d);
     void setKnockbackExtraVertical(double d);
