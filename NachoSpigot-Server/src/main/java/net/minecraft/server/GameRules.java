...
public class GameRules {
    private final TreeMap<String, GameRules.GameRuleValue> gameRules = Maps.newTreeMap();
    ...
    public GameRules() {
        ...
        this.a("forceRespawn", "false", EnumGameRuleType.BOOLEAN_VALUE);
    }

    public void a(String var1, String var2, GameRules.EnumGameRuleType var3) {
        this.gameRules.put(var1, new GameRules.GameRuleValue(var2, var3));
    }

    public void set(String var1, String var2) {
        GameRules.GameRuleValue var3 = this.gameRules.get(var1);
        if (var3 != null) {
            var3.a(var2);
        } else {
    ...
    public String get(String var1) {
        GameRules.GameRuleValue var2 = this.gameRules.get(var1);
    ...
    public NBTTagCompound a() {
        ...
        Iterator var2 = this.gameRules.keySet().iterator();

        while(var2.hasNext()) {
            String var3 = (String)var2.next();
            GameRules.GameRuleValue var4 = this.gameRules.get(var3);
    ...
    public String[] getGameRules() {
        Set var1 = this.gameRules.keySet();
        return (String[])var1.toArray(new String[var1.size()]);
    }

    public boolean contains(String var1) {
        return this.gameRules.containsKey(var1);
    }
